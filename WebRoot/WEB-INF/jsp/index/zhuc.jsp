...
else
{
    ...
    if(!reg.test(email))
    {
        $("#emailspan").html("电子邮箱格式不正确");
		 $("#emailspan").show();
        return false;
    }else{
		 $("#emailspan").html('<p class="duihao"></p>');
		$("#emailspan").show();
		 return true;
	 }
}
           ...
           <table> 
            <tbody>
             ...
             <tr> 
              ...
              <td><input type="email" name="email" id="email" class="px"  size="25" maxlength="25" onblur="isemail();"/></td> 
              <td class="tipcol" colspan="3">
