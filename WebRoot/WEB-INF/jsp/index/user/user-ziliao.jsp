...
<script type="text/javascript">
    ...
    if(!reg.test(mobile))
    {
        ...
        return false;
		 ...
		 $("#phonespan").html('<p class="duihao"></p>');
		$("#phonespan").show();
		 return true;
	 }
}
       ...
       <table cellspacing="0" cellpadding="0" class="tfm" id="profilelist"> 
        <tbody>
         ...
         <tr id="tr_birthday"> 
          ...
          <td id="td_birthday"> 
         <input name="mobile" id="mobile" value="${sessionScope.indexuser.mobile}"  class="px" size="11" onblur="isphone()"/>
           <div class="rq mtn" id="showerror_birthday"></div><p class="d"></p></td> 
           <td class="tipcol" colspan="3">
              <i id="phonespan" class="p_tip" style="color: red"></i>
              </td> 
         </tr> 
         <tr id="tr_birthday"> 
