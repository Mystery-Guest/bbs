      ...
      <div class="form-group">
        ...
        <c:if test="${user.flag==0}">
          ...
          <c:if test="${user.groupid!=1}">
           ...
           <c:if test="${user.groupid==2}">
	          <a class="button border-main" href="javascript:void(0)" onclick="updategroup(${user.id},3)"><span class="icon-edit"></span> 取消版主</a>
          </c:if>
          <c:if test="${user.groupid!=2}">
	          <a class="button border-main" href="javascript:void(0)" onclick="updategroup(${user.id},2)"><span class="icon-edit"></span> 设置版主</a>
          </c:if>
